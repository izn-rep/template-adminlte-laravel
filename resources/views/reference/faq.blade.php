...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Application Menus
      <small>References > F.A.Q Benefit</small>
    </h1>        
  </section>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            <table id="faq-tbl" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if ($value->cover == 1){ ?>
                        <span class="label label-success">Ditanggung</span>
                      <?php } elseif ($value->cover == 0) { ?>
                        <span class="label label-danger">Tidak Ditanggung</span>
                      <?php } else { ?>
                        <span class="label label-warning">Belum Jelas</span>
                      <?php } ?>
                    </td>
...
<script src="{{url('/')}}/resources/assets/js/faq.js"></script>
