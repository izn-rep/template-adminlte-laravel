              ...
              <tbody>
                ...
                <?php foreach ($users as $key => $value): ?>
                  <tr>
                    ...
                    <td>
                      <?php if ($value->profile_id == '' or $value->profile_id == null){ ?>
                        <span class="label label-warning">Not Mapping</span>
                      <?php } else { ?>
...
<script src="{{url('/')}}/resources/assets/js/users.js"></script>
