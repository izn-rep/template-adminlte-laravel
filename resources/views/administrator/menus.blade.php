...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Application Menus
      <small>Administrator > Menu</small>
    </h1>        
  </section>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            <table id="menu-tbl" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th align="center">No</th>
                  <th align="center">Label Menu</th>
                  <th align="center">Description</th>
                  <th align="center">Fa-Icon</th>
                  <th align="center">URL</th>
                  <th align="center">Parent Menu</th>
              ...
              <tbody>
                ...
                <?php foreach ($menus as $key => $value): ?>
                  <tr>
                    ...
                    <td align="center"><?php echo '<i class="fa '.$value->icon.'"></i>' ?></td>
...
<script src="{{url('/')}}/resources/assets/js/menus.js"></script>
